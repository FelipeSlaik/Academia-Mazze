      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 sm:gap-8">
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-gray-400 max-w-sm text-sm sm:text-base">
            Venha treinar com a gente na Academia Mazze em São Roque! Transforme
            sua vida.
          </p>
        </div>

        <div className="flex flex-col items-center md:items-start gap-4">
          <h3 className="font-bold text-sm md:text-lg lg:text-xl mb-2 whitespace-nowrap">Siga-nos</h3>
