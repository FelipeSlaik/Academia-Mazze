    ...
    return(
        <div className="py-20 bg-gray-100">
            <div className="max-w-6xl mx-auto text-center mb-12">
                <h2 className="text-6xl font-bold">Nossos Diferenciais</h2>
                <p className="mt-4 text-gray-600 text-2xl font-medium">O que faz nossa academia ser única?</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                {features.map((feature, index) => {
                    ...
                    return(
                        ...
                        >
                            <Icon className="w-16 h-16 text-red-700 mb-4"/>
